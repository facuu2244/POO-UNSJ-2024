...
#Metodos que permiten iterar la lista 
    def __iter__(self):
        return self
    def __next__(self):
        if self.__indice==self.__tope:
            ...
            self.__indice+=1
            publi=self.__actual.dar_publicacion()
            self.__actual=self.__actual.dar_siguiente()
            return publi
    ...
    def cargar(self, ruta_cd, ruta_libros):
        with open(ruta_cd, "r") as archi_cd: #carga los cd
            ...
            for fila in reader:
                ...
                self.__actual=un_nodo #El nodo actual al iterar es el ultimo agregado a la lista
                self.__tope+=1
    ...
    def consultar(self):
        ...
        while valido==0:
            try:
                ...
                assert posicion<=self.__tope and posicion>0
